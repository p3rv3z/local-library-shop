                ...
                <form method="POST" action="{{ route('admin.collections.update', $collection->id) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <x-adminlte-input name="name" value="{{ old('name', $collection->name) }}"
                        ...
                        <div class="">
                            ...
                            <x-adminlte-select name="status" required>
                                <option value="1" @if (old('status', $collection->status)) selected @endif>{{ __('Active') }}
                                </option>
                                <option value="0" @if (!old('status', $collection->status)) selected @endif>{{ __('Inactive') }}
                                </option>
                            </x-adminlte-select>
                        </div>
                    </div>
