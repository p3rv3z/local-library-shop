            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('admin.categories.index') }}">{{ __('Collections') }}</a></li>
                    <li class="breadcrumb-item active">{{ __('Add Collection') }}</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="card card-outline card-primary">
                ...
                <div class="card-header">
                    <h3 class="card-title">{{ __('Add Collection') }}</h3>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <x-adminlte-select name="status" required>
                                ...
                                <option value="0" @if (!old('status') and old('status') != null) selected @endif>{{ __('Inactive') }}
                                </option>
                            </x-adminlte-select>
                        </div>
                    </div>
