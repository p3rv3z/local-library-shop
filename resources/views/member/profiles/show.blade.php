              ...
              <div class="widget personal-info">
                ...
                <form action="#">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="first-name" value="{{ $user->date_of_birth }}" disabled>
                  </div>
                  <div class="form-group">
                    <label for="first-name">Gender</label>
                    <input type="text" class="form-control" id="first-name" value="{{ $user->gender }}" disabled>
                  </div>
                  <div class="form-group">
                    <label for="first-name">Phone</label>
                    <input type="text" class="form-control" id="first-name" value="{{ $user->phone }}" disabled>
                  </div>
                  <div class="form-group">
                    <label for="first-name">Address</label>
                    <input type="text" class="form-control" id="first-name" value="{{ $user->address }}" disabled>
                  </div>
                  <!-- Last Name -->
{{--                  <div class="form-group">--}}
